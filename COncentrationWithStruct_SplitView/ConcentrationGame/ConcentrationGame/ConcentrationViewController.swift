...
//Here we have concentration game using struct as weel as themes ptovided to usre to set emojis and usage of split view controller 
...
class ConcentrationViewController: UIViewController
{
    ...
    private var emojiChoices = "👻👹👿😎👹🐶🐥🐹😇😱" // make it as string of chars
    //["👻","👹","👿","😎","👹","🐶","🐥","🐹","😇","😱"]
